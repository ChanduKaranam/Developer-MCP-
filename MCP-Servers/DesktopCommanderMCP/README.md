...
Development Commander puts all dev tools in one chat.
Execute long-running terminal commands on your computer and manage processes through Model Context Protocol (MCP).
...
cd .\MCP-Servers\DesktopCommanderMCP
...
"Developmet MCP": {
"command": "node",
"args": [".\\MCP\\DesktopCommanderMCP\\dist\\index.js"] # Absolute Path 
}
}
}
...
And you can use the Server properly 
